...
export const routes = [
    ...
    { path: '/ops/schedule', component: MonthlyCalendar, display: 'Monthly Schedule', beforeEnter: checkAuth, preload },
    { path: '/ops/approveSchedule', component: GMApproveSchedule, display: 'GM Approval', beforeEnter: checkAuth },
